...
if(!isNonEmptyArray(columnsArray) || !isNonEmptyArray(dataArray) || !tableId){
    ...
    throw new Error("Para uma correta execução, precisamos de uma array com as colunas, outra com as informações das linhas e também o id do elemento tabela selecionado ");
};

const tableElement= document.getElementById(tableId);
if (!tableElement || tableElement.nodeName !== 'TABLE') {

    throw new Error('Id informado não corresponde a um elemento table');
}
...
/*<table></table> ||
    ...
    for(const tableColumnObject of columnsArray) {
        ...
        //<tr><th class='text-center'>nome da coluna</th></tr><tr><th class='text-center'>nome da coluna</tr></th>
